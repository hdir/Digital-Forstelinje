...
Given the input from stakeholders collected in the directory background\helsereform-august\markdown\6-kommuner-og-kommunesektor
...
* analyze the barriers and problems identified by the different stakeholders
* Give a summary of the problems and barriers identified by the stakeholders especially the ones identified by several stakeholders.
  * Include a list of all the stakeholders that mentions the recurring barrier
  * Only list the name of the stakeholder that mentions the barrier, not the file name
...
* Can you write the result to background\helsereform-august\barriers\helsereform-barriers-kommuner-og-kommunesektor.md
