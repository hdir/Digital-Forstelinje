...
Fargene er hentet fra referansediagrammet `docs/why/arkitektur-motivasjon.drawio` og er
forpliktende for både Draw.io og PlantUML.

| ArchiMate-lag | Farge | Hex | Bruk |
|---|---|---|---|
| Motivation | Lys lilla | `#CCCCFF` | Drivere, interessenter, mål, outcome, verdi, krav, prinsipper, beskrankninger, barriere/assessment |
| Strategy | Lys krem | `#F5DEAA` | Verdikjede, kapabilitet, tiltak, ressurs |
| Business | Lys gul | `#ffff99` | Roller, aktører, forretningsprosesser, tjenester, forretningsobjekter/informasjon |
| Application | Lys cyan | `#99ffff` | Applikasjonskomponenter, applikasjonsgrensesnitt, applikasjonstjenester, dataobjekter |
| Technology | Lysegrønn | `#C0E6C0` | Noder, infrastruktur, nettverk |
| Grupperingsboks | — | `fillColor=none` + `dashed=1` | Lag-/sone-inndeling (Hvorfor, Strategi for realisering, Forretningsarkitektur, Applikasjonsarkitektur, Rammer, Motivasjon) |

**Tekstfarge:** alltid `#333333` for god kontrast på lyse bakgrunner.
...
rectangle "Forretningslag" <<$archimate/business>> #ffff99 {
    Business_Actor(pasient, "Pasient")
    Business_Actor(helsepersonell, "Helsepersonell")
    Business_Process(behandling, "Behandling")
}

rectangle "Applikasjonslag" <<$archimate/application>> #99ffff {
...
Fyllfargene følger referansediagrammet `docs/why/arkitektur-motivasjon.drawio`. Bruk
samme `fillColor` per lag i alle nye diagrammer:

| Element | style-attributter |
|---|---|
| Motivasjonslag | `fillColor=#CCCCFF;fontColor=#333333` |
| Strategilag | `fillColor=#F5DEAA;fontColor=#333333` |
| Forretningslag | `fillColor=#ffff99;fontColor=#333333` |
| Applikasjonslag | `fillColor=#99ffff;fontColor=#333333` |
| Teknologilag | `fillColor=#C0E6C0;fontColor=#333333` |
| Grupperingsboks (lag/sone) | `shape=mxgraph.archimate3.application;appType=grouping;archiType=square;dashed=1;fillColor=none;align=left` |
| Relasjoner | `strokeColor=#666666;fontColor=#333333` |

**VIKTIG:**
- Bruk alltid `fontColor=#333333` for god lesbarhet.
- Ikke sett egen `strokeColor` på ArchiMate-shapes — Draw.io henter standard
  konturfarge fra ArchiMate-temaet, og dette matcher referansediagrammet.
